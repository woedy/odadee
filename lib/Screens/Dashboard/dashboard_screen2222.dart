                                          ...
                                          itemBuilder: (context, index) {
                                            return Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Image(image: AssetImage("assets/images/dash_post.png", ), height: 80,),
                                                  SizedBox(
                                                    height: 8,
                                                  ),
                                                  Row(
                                                  ...
                                                  Text(eventsData.events.data[index].startDate, style: TextStyle( fontSize: 12, color:Colors.grey),),
                                              ...
                                              child: Container(
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    ...
                                                    Row(
                                                      children: [
                                                        Expanded(child: Text(projectsData.projects.data[index].title, style: TextStyle( fontSize: 16, color: Colors.black),)),
                                                      ],
                                                    ),
                                                    SizedBox(
                                                      height: 5,
